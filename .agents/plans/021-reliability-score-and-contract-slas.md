...
- [x] **Phase 1 — Reliability domain model and persistence**
...
- [x] **Phase 2 — SLA evaluation and reliability scoring**
...
- [x] **Phase 3 — Reliability-aware contract market shaping**
...
- [x] **Phase 4 — Player-facing UI and feedback**
