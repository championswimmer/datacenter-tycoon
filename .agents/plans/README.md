...
- [`035-shared-gameplay-query-surface.md`](./035-shared-gameplay-query-surface.md) — move cross-interface gameplay queries and state interpretation out of web/cli and into authoritative game-logic helpers. _status: created_
