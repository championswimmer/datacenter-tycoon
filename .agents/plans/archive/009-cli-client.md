...
- [x] **Phase 4 — One-shot CLI subcommands**
...
- [x] **Phase 6 — Polish & docs**
  - [x] 6.1 Write `packages/cli/README.md` and `packages/cli/AGENTS.md`
  - [x] 6.2 Add `npm run dev:cli` script and update root `AGENTS.md`
  - [x] 6.3 Integration test: spawn daemon, run subcommands, assert save shape
  - [x] 6.4 Release notes / CHANGELOG entry
