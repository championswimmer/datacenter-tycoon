...
- [ ] **Phase 4 — App shell & routing**
  ...
  - [ ] 4.3 Main viewport: tabbed view per datacenter (Floor / Power / Contracts) — URL state via hash routing (no router dep)
  - [ ] 4.4 Right rail: alerts/log feed (last N ledger entries, contract events)
