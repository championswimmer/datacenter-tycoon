//# hash=aa3a052d4582dba799b158986be420c1
...
test.use({
    program: {
        ...
        args: [
            "--import",
            "tsx",
            resolve(process.cwd(), "bin/dct.js")
        ]
    }
});
test("Prototype testing TUI", function(param) {
        ...
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    ...
                    return [
                        4,
                        expect(terminal.getByText("Dashboard", {
                            strict: false
                        })).toBeVisible()
                    ];
                case 1:
                    ...
                    return [
                        4,
                        expect(terminal.getByText("Cash:", {
                            strict: false
                        })).toBeVisible()
                    ];
                case 2:
                    ...
                    return [
                        4,
                        expect(terminal.getByText("Datacenters", {
                            strict: false
                        })).toBeVisible()
                    ];
                case 3:
                    ...
                    return [
                        4,
                        expect(terminal.getByText("Contracts", {
                            strict: false
                        })).toBeVisible()
                    ];
                case 4:
...
test("TUI responsive design (snapshots)", function(param) {
    var terminal = param.terminal;
    return _async_to_generator(function() {
        return _ts_generator(this, function(_state) {
            switch(_state.label){
