//# hash=e8612e863f076b418013e9b99cfd3920
...
test("dct with no args lazy-loads the TUI and exits on q", function() {
    return _async_to_generator(function() {
        var _child_stdout, _child_stdin, child, stdout, exitCode;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                ...
                case 1:
                    _state.sent();
                    (_child_stdin = child.stdin) === null || _child_stdin === void 0 ? void 0 : _child_stdin.write("q");
                    return [
                        4,
