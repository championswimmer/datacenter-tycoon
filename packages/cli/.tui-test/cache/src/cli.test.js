//# hash=aa9dfc3e77f4f8df7612719daf4b6d68
...
test("runCli rejects unknown commands with a help hint", function() {
...
test("dct --help prints the command list", function() {
    return _async_to_generator(function() {
        var child, stdout;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                    ...
                    return [
                        ...
                        new Promise(function(resolve, reject) {
                            ...
                            child.once("close", function(code) {
                                if (code !== 0) {
                                    reject(new Error("help exited with code ".concat(code)));
                                    return;
                                }
                                resolve(output);
                            });
