//# hash=fe211c91e20aba24172b53bf4e342014
//# sourceMappingURL=paths.test.js.map

import test from "node:test";
import assert from "node:assert/strict";
import { resolvePathsForPlatform } from "./paths.js";
test("resolvePathsForPlatform uses XDG paths on Linux", function() {
    var resolved = resolvePathsForPlatform({
        platform: "linux",
        env: {
...
test("resolvePathsForPlatform uses macOS conventions", function() {
    var resolved = resolvePathsForPlatform({
        platform: "darwin",
        env: {},
        homeDir: "/Users/alice",
...
test("resolvePathsForPlatform uses Windows conventions", function() {
    var resolved = resolvePathsForPlatform({
        platform: "win32",
        env: {
...
test("resolvePathsForPlatform honors explicit overrides", function() {
    var resolved = resolvePathsForPlatform({
        platform: "linux",
        env: {},
        homeDir: "/home/alice",
